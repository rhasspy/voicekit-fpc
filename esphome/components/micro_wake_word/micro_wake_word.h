...
class MicroWakeWord : public Component {
 public:
  ...
  Trigger<> *get_audio_uploaded_trigger() const { return this->audio_uploaded_trigger_; }
 ...
 protected:
  ...
  std::unique_ptr<RingBuffer> fpc_ring_buffer_;
  int16_t *fpc_audio_buffer_{nullptr};
  esp_http_client_handle_t fpc_client_ = nullptr;
  Trigger<> *audio_uploaded_trigger_ = new Trigger<>();
  std::string upload_hostname_ = "";
  int upload_port_ = 11223;
